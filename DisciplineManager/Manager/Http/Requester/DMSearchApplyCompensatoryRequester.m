//
//  DMSearchApplyCompensatoryRequester.m
//  DisciplineManager
//
...
@interface DMSearchApplyCompensatoryRequester () <DMRequesterDelegate>

@end

@implementation DMSearchApplyCompensatoryRequester
...
- (id)onDumpData:(NSDictionary *)jsonObject {
    ...
    for (NSDictionary *dict in rows) {
        DMApplyCompensatoryListInfo *acInfo = [[DMApplyCompensatoryListInfo alloc] initWithDict:dict];
