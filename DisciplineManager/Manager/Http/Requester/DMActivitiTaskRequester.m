...
@interface DMActivitiTaskRequester () <DMRequesterDelegate>

@end

@implementation DMActivitiTaskRequester
...
- (id)onDumpData:(NSDictionary *)jsonObject {
    ...
    for (NSDictionary *dict in rows) {
        DMActivitiTaskModel *ltInfo = [[DMActivitiTaskModel alloc] initWithDict:dict];
