...
@interface DMSearchExhRequester () <DMRequesterDelegate>

@end

@implementation DMSearchExhRequester
...
- (id)onDumpData:(NSDictionary *)jsonObject {
    ...
    for (NSDictionary *dict in rows) {
        DMExhListModel *elInfo = [[DMExhListModel alloc] initWithDict:dict];
        [listModel.rows addObject:elInfo];
    }
