...
@interface DMSearchApplyLeaveRequester () <DMRequesterDelegate>

@end

@implementation DMSearchApplyLeaveRequester
...
- (id)onDumpData:(NSDictionary *)jsonObject {
    ...
    for (NSDictionary *dict in rows) {
        DMApplyLeaveListInfo *acInfo = [[DMApplyLeaveListInfo alloc] initWithDict:dict];
        [listModel.rows addObject:acInfo];
    }
...
- (NSString *)getChildrenUrl {
    return @"xysgsj/jgxt/api/leave/search.do";
}
