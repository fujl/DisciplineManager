...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRGB:0xefefef] size:CGSizeMake(1.0f, 1.0f)] forBarMetrics:UIBarMetricsDefault];
}
