...
@interface DMSuperviseGetRequester () <DMRequesterDelegate>

@end

@implementation DMSuperviseGetRequester
...
- (id)onDumpData:(NSDictionary *)jsonObject {
    ...
    DMSuperviselistInfo *slInfo = [[DMSuperviselistInfo alloc] initWithDict:errData];
    return slInfo;
}
...
- (NSString *)getChildrenUrl {
    return @"jgxt/api/supervise/get.do";
}
