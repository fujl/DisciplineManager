...
@interface DMApplyOutViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation DMApplyOutViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.title = NSLocalizedString(@"ApplyOut",@"外出申请");
...
- (void)clickApply {
    DMFillinApplyOutController *controller = [[DMFillinApplyOutController alloc] init];
...
- (void)loadNewData {
    ...
    [requester postRequest:^(DMResultCode code, id data) {
        ...
        if (code == ResultCodeOK) {
            ...
            NSMutableArray<DMApplyOutListInfo*> *list = listModel.rows;
